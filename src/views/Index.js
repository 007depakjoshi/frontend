    ...
    <>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Home Delivered Quality Services, on demand
              </h2>
              ...
              <div className="mt-12">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    ...
                    placeholder="Makeup Artist, Mechanic, Cleaning, Lanscaping..."
        ...
        <img
          ...
          src={require("assets/img/bgimg.png").default}
          alt="..."
        />
      </section>
                  ...
                  <Link to="/auth/login">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        src={require("assets/img/painting.jpg").default}
                      />
                    </div>
                  </Link>
                </div>
                  ...
                  <Link to="/profile">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={require("assets/img/maekup.jpg").default}
                      />
                    </div>
                  </Link>
                </div>
                  ...
                  <Link to="/landing">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={require("assets/img/sap1.jpg").default}
                      />
                    </div>
                  </Link>
                </div>
